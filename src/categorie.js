...
(function (root) {
  ...
  var CATEGORIEEN = [
    ...
    { id: 'bankkosten',   naam: 'Bankkosten',           soort: 'vast',     kleur: '#7f8fa0' },
  ...
  var REGELS = [
    ...
    ['verzekering',  'centraal beheer|univ[eé]|interpolis|nationale.?ned|a\\.?s\\.?r|aegon|allianz|reaal|inboedel|aansprakelijkheid'],
    ['telecom',      'kpn|ziggo|odido|t.?mobile|vodafone|simyo|tele2|delta fiber|caiway|hollandsnieuwe'],
    ['abonnement',   'cineville|duxsoup|bibliotheek|\\bnpo\\b|netflix|spotify|disney|videoland|hbo|max\\b|apple\\.com|apple store.*abo|icloud|itunes|google (one|storage|play)|youtube|openai|anthropic|claude|microsoft|adobe|dropbox|notion|github|steam.*abo|patreon|krant|nrc|volkskrant|telegraaf|fd\\b'],
